          ...
          /*  else if(c.Case_Record_Type__c == 'Zoning Residential')  {
            ...
            // Workflow Implementation for Street Trees.
             ...
             // Workflow Implementation for Traffic Signal Emergency.
               ...
               //Changes for support ticket #11761422  - START 
                if ( ((c.Origin == 'Web')||(c.Origin == 'Mobile')) && (userinfo.getName() == 'PublicStuff User') ) {
                    c.Problem_Type__c = 'Other';
                }
               //Changes for support ticket #11761422  - END
                ...
                else if(((c.Origin != 'Web')&&(c.Origin != 'Mobile'))&&((c.Request_to_Modify_Traffic_Signal_Operati__c == 'Yes') || (c.Signal_Type__c == 'Signal Other') || (c.Blocked_by_Tree_Branches_or_Foliage__c == 'Yes') || ((c.Signal_Type__c != 'Traffic Signal') && (c.Problem_Type__c != 'Knocked Down'))))
